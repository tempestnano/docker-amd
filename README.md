...
[![Docker Build](https://img.shields.io/docker/cloud/automated/tempestnano/amd?style=flat-square)](https://hub.docker.com/r/tempestnano/amd)
[![Docker Pulls](https://img.shields.io/docker/pulls/tempestnano/amd?style=flat-square)](https://hub.docker.com/r/tempestnano/amd)
[![Docker Stars](https://img.shields.io/docker/stars/tempestnano/amd?style=flat-square)](https://hub.docker.com/r/tempestnano/amd)
...
Container images are configured using parameters passed at runtime (such as those above). These parameters are separated by a colon and indicate `<external>:<internal>` respectively. For example, `-p 8080:80` would expose port `80` from inside the container to be accessible from the host's IP on port `8080` outside the container. See the [wiki](https://github.com/tempestnano/docker-amd/wiki) to understand how it works.
